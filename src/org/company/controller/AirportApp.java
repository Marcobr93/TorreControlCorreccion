...
import org.company.modelo.Flight;
import org.company.modelo.Radar;
...
public class AirportApp {
    ...
    private void loadTestFlights() {
        ...
        radar.addflight( new Flight("RY101", "Ryanair", 180000.0, 410.5, new Date()));
        ...
        while ((option = showMenu()) != 0) {
            switch (option) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    radar.ordenacionPorCodigoVuelo();
                    break;
                case 6:
                    radar.eliminarVuelo();
                    break;
    ...
    private int showMenu() {
        ...
        System.out.println("* 5 - Lista por cod. vuelo *");
